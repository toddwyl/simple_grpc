...
// UserServiceClient is the client API for UserService tcp_service.
//
...
func (c *userServiceClient) EditUser(ctx context.Context, in *EditUserRequest, opts ...grpc.CallOption) (*EditUserReply, error) {
...
// UserServiceServer is the server API for UserService tcp_service.
...
// UnsafeUserServiceServer may be embedded to opt out of forward compatibility for this tcp_service.
...
// UserService_ServiceDesc is the grpc.ServiceDesc for UserService tcp_service.
